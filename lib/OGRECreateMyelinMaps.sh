...
${FSLDIR}/bin/applywarp --rel --interp=spline -i $OutputMNIT1wImageRestore -r $T1wTemplateLow --premat=$FSLDIR/etc/flirtsch/ident.mat -o ${StudyFolder}/${T1wImageFile}.${FinalfMRIResolution}
